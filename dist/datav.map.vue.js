                            ...
                            _c(
                              "tspan",
                              {
                                attrs: {
                                  x: point.text.x,
                                  y: point.text.y + 15,
                                  fill: point.text.color_speed,
                                },
                              },
                              [_vm._v(_vm._s(point.speed))]
                            ),
                          ]
                        )
                      : _vm._e(),
